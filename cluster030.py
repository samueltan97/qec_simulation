...
if __name__ == "__main__":
    ...
    for burst_error_rate in burst_error_rates:
        ...
        simulation.simulation_results_to_csv(data_dictionary, '030_results_expanded_0711')
    
    
    # data_dictionary = pd.read_csv('030_results_expanded_0711.csv')
    ...
    #     plt.plot(np.linspace(0.1, 0.13, 300), res.intercept + res.slope*np.linspace(0.1, 0.13, 300), c=color)
