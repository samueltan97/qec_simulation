...
if __name__ == "__main__":
    ...
    colors = cycle(['tab:blue', 'tab:orange', 'tab:red', 'yellow','green'])
    num_shots = 10000
    ...
    burst_error_rates = np.linspace(0.095, 0.125, 5)
    for burst_error_rate in burst_error_rates:
        ...
        simulation.simulation_results_to_csv(data_dictionary, '030_results_expanded_0713_2')
    
    
    # data_dictionary = pd.read_csv('030_results_expanded_0713.csv')
    ...
    # plt.minorticks_on()
    # plt.savefig(str(noises[0] * 100) + '%_phenomenological_noise_burst_error_threshold_new_0713.png', bbox_inches="tight")
    # plt.clf()
