type Graph
    # the keys of adj will be a tuple (node_id, node_coordinates, node_is_boundary)
    # the values will be a dictionary with neighbor node_id as key and a Dict (weight, qubit_id, error_probability) as the value
    adj::Dict{Any, Dict{Any, Dict{Any, Any}}}   
end

Graph() = Graph(Dict{Any, Dict{Any, Dict{Any, Any}}}())
