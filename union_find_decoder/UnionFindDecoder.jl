...
function initialize_cluster_trees_with_detector_parts(detection_data, node_coord_dict)
    ...
    for i in eachindex(detection_data)
        push!(cluster_set, Dict("rootnode"=>ClusterTreeNode.ClusterTreeNode([i, node_coord_dict[i]]), 
